...
public class MemberServiceImpl implements MemberService {
    ...
    public ServerResponse login(String loginname, String password) {
       ...
       /* //将会员对象转为JSON格式的字符串
        ...
        //将用户的登录状态存放到redis中
        redisTemplate.opsForValue().set("member:" + loginMember.getUuid(),232324,10, TimeUnit.MINUTES);
    ...
    @Override
    public List<Area> getPidByArea(Integer pid) {
        return memberMapper.getPidByArea(pid);
    }
